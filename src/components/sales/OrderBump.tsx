      ...
      <div className="container-sales relative z-10">
        <div className="text-center mb-10">
          ...
          <h2 className="section-title">
            Melhore seus <span className="text-shimmer">resultados</span>
          </h2>
          <p className="section-subtitle">
            Adicione estes complementos ao seu pedido com até 70% de desconto
          </p>
        </div>
              ...
              >
                <div className="p-4 sm:p-5 flex items-start gap-3 sm:gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    >
                      {isChecked
                        ? `✓ Adicionado! ${bump.name} por ${bump.bumpPrice}`
                        : `Sim! Quero adicionar ${bump.name} por apenas ${bump.bumpPrice}`}
                    </p>
                  </div>
                </div>
              </label>
            ...
            <div className="card-glow !p-5 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="text-center sm:text-left">
                <p className="text-cream/70 text-sm">
                  {Object.values(checked).filter(Boolean).length} complemento(s) adicionado(s)
                </p>
        ...
        <p className="text-center text-cream/40 text-sm mt-8 max-w-xl mx-auto">
          Estes complementos são oferecidos exclusivamente nesta etapa. Ao continuar para o
          checkout, você poderá confirmar sua seleção.
        </p>
      </div>
    </section>
  )
