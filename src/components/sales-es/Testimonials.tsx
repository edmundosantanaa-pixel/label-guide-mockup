      ...
      <div className="container-sales relative z-10">
        <div className="text-center mb-12">
          <h2 className="section-title">
            Quiénes ya transformaron su <span className="text-shimmer">vida</span>
          </h2>
          <p className="section-subtitle">
            Historias reales de personas que rescataron su autoestima
          </p>
        </div>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-cream/60 text-sm">{t.age} años • {t.location}</p>
